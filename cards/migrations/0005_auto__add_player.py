...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Player'
        db.create_table(u'cards_player', (
        ...
        db.send_create_signal(u'cards', ['Player'])

        # Adding M2M table for field groups on 'Player'
        m2m_table_name = db.shorten_name(u'cards_player_groups')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('player', models.ForeignKey(orm[u'cards.player'], null=False)),
            ('group', models.ForeignKey(orm[u'auth.group'], null=False))
        ))
        db.create_unique(m2m_table_name, ['player_id', 'group_id'])

        # Adding M2M table for field user_permissions on 'Player'
        m2m_table_name = db.shorten_name(u'cards_player_user_permissions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('player', models.ForeignKey(orm[u'cards.player'], null=False)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cards_player')

        # Removing M2M table for field groups on 'Player'
        db.delete_table(db.shorten_name(u'cards_player_groups'))

        # Removing M2M table for field user_permissions on 'Player'
        db.delete_table(db.shorten_name(u'cards_player_user_permissions'))
    ...
    models = {
        ...
        u'cards.card': {
            ...
            'alt_image': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
